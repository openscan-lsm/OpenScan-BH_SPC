...
class MyProcessor : public RateCountsProcessor {
  ...
  public:
    explicit MyProcessor(RateCounts &destination) : destination(destination) {}
...
extern "C" struct RateCounts *StartRateCounterMonitor(short module,
    ...
    ret->monitor =
        std::make_unique<RateCounterMonitor>(module, proc, intervalSeconds);
    return ret;
}
